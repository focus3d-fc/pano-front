...
public class Override {
    ...
    public static void main(String[] args) {
        // 静态方法调用
        String maskCharWay = Override.getMaskCharWay("15197447018",3,9);
        System.out.println(maskCharWay);
        Override.getMaskCharWay("15197447018",3,9);
        String maskCharWay2 = Override.getMaskCharWay("15197447018",3,9,'-');
        System.out.println(maskCharWay2);
        Override.getMaskCharWay("15197447018",3,9,'-');
        // 实例方法调用
